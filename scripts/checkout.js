...
cart.forEach((cartItem)=>{
  ...
  cartSummary+=`
  <div class="cart-item-container js-remove-cart-${matchingItem.id} js-cart-item-container-${matchingItem.id}">
    ...
    <div class="cart-item-details-grid">
      ...
      <div class="cart-item-details">
        ...
        <div class="product-quantity">
          ...
          <span class="update-quantity-link link-primary js-update-cart" data-update-cart=${matchingItem.id}>
            Update
          </span>
...
href="amazon.html">${cartQuantity}</a>)`;
 ...
 document.querySelectorAll('.js-update-cart').forEach((cartItem)=>{
  cartItem.addEventListener('click',()=>{
    const productId = cartItem.dataset.updateCart;
